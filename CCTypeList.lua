...
--  objClass:Add(CCType.new({SpellId=30283, Class=L["WARLOCK"], CCType="CC", CCName=L["Shadowfury"], DRType="CS", Duration=3, IsCore=false, CastTime=0, Cooldown=30, Targeted=false, Ranged=true, RequiresStealth=false, IsChannelled=false, Weighting=8085}))
  ...
  objClass:Add(CCType.new({SpellId=64044, Class=L["PRIEST"], CCType="CC", CCName=L["Psychic Horror"], DRType="H", Duration=1, IsCore=false, CastTime=0, Cooldown=45, Targeted=true, Ranged=true, RequiresStealth=false, IsChannelled=false, Weighting=6378}))
